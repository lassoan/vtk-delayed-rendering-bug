...
ShareCameraQt::ShareCameraQt()
{
  ...
  vtkRenderer* rightRendererPtr = rightRenderer;
  vtkGenericOpenGLRenderWindow* rightRenderWindowPtr = renderWindowRight;
  QTimer::singleShot(3000, [rightRendererPtr, rightRenderWindowPtr]() {
    qDebug() << "Setting background to red and rendering";
    rightRendererPtr->SetBackground(1.0, 0.0, 0.0);
    rightRenderWindowPtr->Render();
  });
  QTimer::singleShot(6000, [rightRendererPtr, rightRenderWindowPtr]() {
    qDebug() << "Render again";
    rightRenderWindowPtr->Render();
  });
